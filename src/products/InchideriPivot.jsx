...
import B3 from "../assets/pivot2.jpg";
...
import leftimg from "../assets/Pivot.jpg";
import rightimg from "../assets/pivot1.png";
import I6 from "../assets/Imagine4.jpg";
import I7 from "../assets/Bioclimatica-retractabila-edit.jpg";
import I8 from "../assets/zipscreen.jpeg";

import Vv from "../assets/inchiderepivot.mp4";

import SystemCard from "../imports/SystemCard.jsx";

const InchideriPivot = () => {
  ...
  return (
    <div className="mt-20">
        ...
        <div className="grid md:grid-cols-2 grid-cols-1 md:gap-9 gap-6">
          ...
          <div className="flex flex-col justify-center space-y-4 h-full">
            <p className="font-serif text-2xl lg:text-4xl flex">
              Mișcare fluidă, impact vizual!
            </p>
            <p className="font-thin  flex justify-center items-center">
              Sistemele pivotante impresionează prin eleganța funcționalității:
              panourile de sticlă se rotesc în jurul unui ax vertical, oferind o
              deschidere amplă fără a necesita spațiu lateral. Datorită
              designului minimalist și contrastului rafinat dintre sticlă și
              suprafețele solide, aceste sisteme devin elemente arhitecturale
              distinctive. Sunt ideale pentru compartimentări interioare
              moderne, vitrajul fațadelor sau accesul fluid între spații,
              îmbinând estetica cu flexibilitatea funcțională.
            </p>
            <p className="font-serif text-2xl lg:text-4xl flex justify-center items-center">
              Dorești o ofertă pentru închideri pivotante?
            </p>
            <div className="">
              <button
      ...
      <br></br>
      {/*<div className="bg-gradient-to-l to-[#f3f3f3] from-yellow-500 h-1"></div>*/}
      ...
      <div className="md:mx-20 px-8 md:px-0 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-5 gap-8 p-8">
        ...
        <SystemCard
          ...
          onClick={() => console.log("Go to slide-turn")}
        />
        <SystemCard
          image={I7}
          title="Pergole retractabile"
          onClick={() => console.log("Go to folding")}
        />
        <SystemCard
          image={I8}
          title="ZipScreens"
          onClick={() => console.log("Go to terrace")}
        />
      </div>
      <Footer2 />
    </div>
