...
import B3 from "../assets/pvc5.jpeg";
import B4 from "../assets/pvc1.jpg";
import Vv from "../assets/pvc5.jpeg";
...
import leftimg from "../assets/pvc2.jpg";
import rightimg from "../assets/pvc6.jpg";

const RetractabilaPVC = () => {
        ...
        <div className="grid md:grid-cols-2 grid-cols-1 md:gap-9 gap-6">
          ...
          <div className="flex flex-col justify-center space-y-4 h-full">
            <p className="font-serif text-2xl lg:text-4xl flex">
              Protecție completă, eleganță în mișcare!
            </p>
            <p className="font-thin  flex justify-center items-center">
              Pergolele retractabile cu acoperiș din PVC sunt soluția ideală
              pentru spații exterioare care necesită protecție totală împotriva
              ploii, vântului și razelor UV. Acoperișul din PVC triplu
              stratificat este impermeabil, durabil și poate fi retras complet
              pentru a lăsa cerul liber în zilele frumoase. Structura robustă și
              designul modern le fac perfecte pentru terase, grădini,
              restaurante sau hoteluri.
            </p>
            <p className="font-serif text-2xl lg:text-4xl flex justify-center items-center">
              Dorești o ofertă pentru o pergolă retractabilă PVC?
            </p>
            <div className="">
              <button
...
export default RetractabilaPVC;
