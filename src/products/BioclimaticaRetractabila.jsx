...
import B3 from "../assets/Imagine3.jpg";
import B4 from "../assets/Imagine4-edit.jpg";
import Vv from "../assets/bioclimatica-retractabila-1.jpg";
...
import leftimg from "../assets/bioclimatica-retractabila-2.jpg";
import rightimg from "../assets/Pergola-bioclimatica-retractabila.jpg";
    ...
    <div className="mt-20">
      <div className="bg-white -mt-5 ">
        <img
          ...
          alt="Background Pergola Bioclimatica Retractabila"
        ></img>
        <HeroProduct bigText="PERGOLĂ BIOCLIMATICĂ RETRACTABILĂ"></HeroProduct>
      </div>
      ...
      <div className="container h-full md:mx-20 px-8 md:px-0 -mt-10 md:-mt-24">
        <div className="grid md:grid-cols-2 grid-cols-1 md:gap-9 gap-6">
          <div className="flex flex-col justify-center space-y-6 h-full">
            <img
              src={Vv}
              alt="Imagine 1 Pergola Bioclimatica Retractabila"
            ></img>
          </div>
          <div className="flex flex-col justify-center space-y-4 h-full">
            <p className="font-serif text-2xl lg:text-4xl flex">
              Libertate totală, protecție inteligentă!{" "}
            </p>
            <p className="font-thin  flex justify-center items-center">
              Pergolele bioclimatice retractabile oferă un echilibru perfect
              între deschidere completă și protecție maximă. Lamelele mobile pot
              fi retrase complet, permițând expunerea totală la cer în zilele
              senine sau închise rapid pentru umbrire și adăpost în caz de
              ploaie. Ideale pentru terase de lux, restaurante sau spații
              rezidențiale moderne, aceste pergole combină funcționalitatea
              avansată cu un design sofisticat și soluții de automatizare
              inteligentă.
            </p>
            <p className="font-serif text-2xl lg:text-4xl flex justify-center items-center">
              Dorești o ofertă pentru o pergolă bioclimatică retractabilă?
            </p>
            <div className="">
              <button
        ...
        <div className="grid md:grid-cols-2 grid-cols-1 md:gap-9">
          <div className="py-2 flex items-center justify-center">
            <img
              ...
              alt="Left Pergola Bioclimatica Retractabila"
            ></img>
          </div>
          ...
          <div className="py-2 flex items-center justify-center">
            <img
              src={rightimg}
              className="w-full md:h-[400px] object-cover max-w-[600px] overflow-hidden"
              alt="Right Pergola Bioclimatica Retractabila"
            ></img>
          </div>
        </div>
      </div>
